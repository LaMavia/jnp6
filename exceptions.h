...
class TooManyDiceException : public std::exception {
  virtual const char *what() const throw() { return "Za dużo kostek w grze!"; }
};

class TooFewDiceException : public std::exception {
  virtual const char *what() const throw() { return "Za mało kostek w grze!"; }
};

class TooManyPlayersException : public std::exception {
  virtual const char *what() const throw() { return "Za dużo graczy w grze!"; }
};

class TooFewPlayersException : public std::exception {
  virtual const char *what() const throw() { return "Za mało graczy w grze!"; }
};
